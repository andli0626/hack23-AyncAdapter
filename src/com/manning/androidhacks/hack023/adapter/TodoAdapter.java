...
public class TodoAdapter extends CursorAdapter {
	...
	private static final String[] PROJECTION_IDS_TITLE_AND_STATUS = new String[] {TodoContentProvider.COLUMN_ID, TodoContentProvider.COLUMN_TITLE,TodoContentProvider.COLUMN_STATUS_FLAG };
	...
	public TodoAdapter(Activity activity) {
		...
		mInternalIdIndex 		= c.getColumnIndexOrThrow(TodoContentProvider.COLUMN_ID);
		mTitleIndex 			= c.getColumnIndexOrThrow(TodoContentProvider.COLUMN_TITLE);
	...
	public View newView(Context context, Cursor cursor, ViewGroup parent) {
		final View view = mInflater.inflate(R.layout.todo_row, parent, false);

		ViewHolder holder = new ViewHolder();
		holder.id 			= (TextView) view.findViewById(R.id.todo_row_id);
		holder.title 		= (TextView) view.findViewById(R.id.todo_row_title);
		holder.deleteButton = (Button) view.findViewById(R.id.todo_row_delete);
